...
global.reloadHandler = async function(restatConn) {
  ...
  conn.spromote = '💜𝙍𝙐𝘽𝙔 𝘽𝙊𝙏 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀 @user 𝙎𝙀 𝙎𝙐𝙈𝘼 𝘼𝙇 𝙂𝙍𝙐𝙋𝙊 𝘿𝙀 𝘼𝘿𝙈𝙄𝙉𝙎';
  conn.sdemote = '💜𝙍𝙐𝘽𝙔 𝘽𝙊𝙏 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀 @user 𝘼𝘽𝘼𝙉𝘿𝙊𝙉𝘼 𝙀𝙇 𝙂𝙍𝙐𝙋𝙊 𝘿𝙀 𝘼𝘿𝙈𝙄𝙉𝙎';
  conn.sDesc = '💜𝙍𝙐𝘽𝙔 𝘽𝙊𝙏 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀 𝙇𝘼 𝘿𝙀𝙎𝘾𝙍𝙄𝙋𝘾𝙄𝙊𝙉 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊 𝘼 𝙎𝙄𝘿𝙊 𝙈𝙊𝘿𝙄𝙁𝙄𝘾𝘼𝘿𝙊';
  conn.sSubject = '💜𝙍𝙐𝘽𝙔 𝘽𝙊𝙏 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀 𝙀𝙇 𝙉𝙊𝙈𝘽𝙍𝙀 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊 𝘼 𝙎𝙄𝘿𝙊 𝙈𝙊𝘿𝙄𝙁𝙄𝘾𝘼𝘿𝙊';
  conn.sIcon = '💜𝙍𝙐𝘽𝙔 𝘽𝙊𝙏 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀 𝙇𝘼 𝙁𝙊𝙏𝙊 𝘿𝙀 𝙋𝙀𝙍𝙁𝙄𝙇 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊 𝘼 𝙎𝙄𝘿𝙊 𝘾𝘼𝙈𝘽𝙄𝘼𝘿𝙊';
  conn.sRevoke = '💜𝙍𝙐𝘽𝙔 𝘽𝙊𝙏 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀 𝙀𝙇 𝙀𝙉𝙇𝘼𝘾𝙀 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊 𝙎𝙀 𝙃𝘼 𝙍𝙀𝙎𝙏𝘼𝘽𝙇𝙀𝘾𝙄𝘿𝙊';
...
setInterval(async () => {
  ...
  const bio = `፧፧ 𝙍𝙪𝙗𝙮𝘽𝙤𝙩💜 ፧፧ 𝙢𝙖𝙭𝙞𝙢𝙖 𝙥𝙤𝙩𝙚𝙣𝙘𝙞𝙖🤖 ፧፧ 𝘽𝙤𝙩 𝙙𝙚 𝙪𝙨𝙤 𝙥𝙪𝙗𝙡𝙞𝙘𝙤 𝙮 𝙫𝙚𝙣𝙩𝙖𝙨 ፧፧ 𝙄𝙜: @𝙪𝙨𝙭𝙧_𝙖𝙣𝙜𝙚𝙡𝙞𝙩𝙤`;
